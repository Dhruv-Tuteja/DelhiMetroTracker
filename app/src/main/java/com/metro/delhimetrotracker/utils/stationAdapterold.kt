...
////import com.metro.delhimetrotracker.databinding.ItemStationBinding
////import com.metro.delhimetrotracker.databinding.ItemDivergenceMarkerBinding
////import com.metro.delhimetrotracker.databinding.ItemGpsGapMarkerBinding
//
...
//        const val TYPE_DIVERGENCE_MARKER = 1
//        const val TYPE_GPS_GAP_MARKER = 2
//    }
//
...
//    }
////
////    // Inferred stations shown with different visual style
////    private fun bindInferredStation(holder: StationViewHolder, station: MetroStation) {
////        holder.binding.apply {
////            stationName.text = station.stationName
////            stationName.alpha = 0.6f // Slightly faded
////            iconInferred.visibility = View.VISIBLE // "?" icon
////            tvInferredLabel.text = "Inferred"
////        }
////    }
//
...
//) : StationListItem()
//
//data class DivergenceMarker(
//    val reason: String,
//    val timestamp: Long
//) : StationListItem()
//
//data class GPSGapMarker(

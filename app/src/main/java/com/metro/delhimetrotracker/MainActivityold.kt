...
//
//        checkAndOpenScheduleDialog(intent)
//    }
//
...
//    }
//
//    private fun checkAndOpenScheduleDialog(intent: Intent?) {
//        if (intent?.getBooleanExtra("OPEN_SCHEDULE_DIALOG", false) == true) {
...
//        // 0. Trigger a one-time sync to push all pending local changes to the cloud
//        val workManager = androidx.work.WorkManager.getInstance(applicationContext)
//        val syncRequest = androidx.work.OneTimeWorkRequest.Builder(com.metro.delhimetrotracker.worker.SyncWorker::class.java).build()
//        workManager.enqueue(syncRequest)
//
//        // Also sync scheduled trips (this is faster than waiting for work manager)
//        uploadScheduledTripsToCloud()
//
//        lifecycleScope.launch(Dispatchers.IO) {
...
//
//                            // --- LOGGING ADDED ---
//                            Log.d("Restore", "Trip $id: Retrieved ${checkpointsData?.size ?: 0} checkpoints from cloud.")
//
//                            checkpointsData?.forEach { checkpointObj ->
//                                try {
//                                    val checkpointMap = checkpointObj as? Map<*, *>
...
//
//                                        // --- LOGGING ADDED ---
//                                        Log.d("Restore", "Trip $id: Inserted checkpoint ${checkpoint.stationName} successfully.")
//                                    }
//                                } catch (e: Exception) {
...
//
//    // ============================================
//// REFACTORED showStationSelectionDialog
//// Replace lines 920-1114 with these functions
//// ============================================
//
//    fun showStationSelectionDialog(prefilledSource: String? = null, prefilledDest: String? = null) {
//        val prefs = getSharedPreferences("MetroPrefs", MODE_PRIVATE)
//        val dialog = createDialog()
//        val views = initializeViews(dialog)
//
//        setupInitialState(views, prefs, prefilledSource, prefilledDest)
//        loadStationsAndSetupListeners(dialog, views, prefs)
//
//        dialog.show()
//    }
//
...
//        return Dialog(this, android.R.style.Theme_Black_NoTitleBar_Fullscreen).apply {
//            setContentView(R.layout.dialog_station_selector)
//            window?.attributes?.windowAnimations = R.style.DialogSlideAnimation
//        }
//    }
//
//    private data class DialogViews(
//        val sourceAtv: AutoCompleteTextView,
//        val destAtv: AutoCompleteTextView,
//        val btnSwap: MaterialButton,
//        val routePreferenceGroup: RadioGroup,
//        val cbSms: MaterialCheckBox,
//        val layoutPhone: LinearLayout,
//        val phoneEt: TextInputEditText,
//        val btnPickContact: MaterialButton,
//        val switchSchedule: SwitchMaterial,
//        val layoutScheduleOptions: LinearLayout,
//        val tvSelectTime: TextView,
//        val radioGroupFreq: RadioGroup,
//        val layoutDays: LinearLayout,
//        val btnStart: MaterialButton,
//        val btnCancel: MaterialButton,
//        val toolbar: MaterialToolbar,
//        val btnRecharge: MaterialButton
//    )
//
//    private fun initializeViews(dialog: Dialog): DialogViews {
//        return DialogViews(
//            sourceAtv = dialog.findViewById(R.id.sourceAutoComplete),
//            destAtv = dialog.findViewById(R.id.destinationAutoComplete),
//            btnSwap = dialog.findViewById(R.id.btnSwapStations),
//            routePreferenceGroup = dialog.findViewById(R.id.routePreferenceGroup),
//            cbSms = dialog.findViewById(R.id.cbEnableSms),
//            layoutPhone = dialog.findViewById(R.id.layoutPhoneInput),
//            phoneEt = dialog.findViewById(R.id.etPhoneNumber),
//            btnPickContact = dialog.findViewById(R.id.btnPickContact),
//            switchSchedule = dialog.findViewById(R.id.switchSchedule),
//            layoutScheduleOptions = dialog.findViewById(R.id.layoutScheduleOptions),
//            tvSelectTime = dialog.findViewById(R.id.tvSelectTime),
//            radioGroupFreq = dialog.findViewById(R.id.radioGroupFrequency),
//            layoutDays = dialog.findViewById(R.id.layoutDays),
//            btnStart = dialog.findViewById(R.id.btnStart),
//            btnCancel = dialog.findViewById(R.id.btnCancel),
//            toolbar = dialog.findViewById(R.id.toolbar),
//            btnRecharge = dialog.findViewById(R.id.btnRechargeCard)
//        )
//    }
//
...
//    ) {
//        prefilledSource?.let { views.sourceAtv.setText(it) }
//        prefilledDest?.let { views.destAtv.setText(it) }
//        currentDialogPhoneField = views.phoneEt
//        views.phoneEt.setText(prefs.getString("last_phone", ""))
//    }
//
//    private fun loadStationsAndSetupListeners(
//        dialog: Dialog,
//        views: DialogViews,
//        prefs: android.content.SharedPreferences
//    ) {
...
//
//            withContext(Dispatchers.Main) {
//                setupStationAutocomplete(views, stationNames)
//                setupStartButton(dialog, views, prefs, stations)
//                setupSwapButton(views)
//                setupScheduleToggle(views)
//                setupTimeSelection(views)
//                setupFrequencyToggle(views)
//                setupSmsToggle(views)
//                setupContactPicker(views)
//                setupCancelAndToolbar(dialog, views)
//                setupRechargeButton(views)
//            }
//        }
//    }
//
//    private fun setupStationAutocomplete(views: DialogViews, stationNames: List<String>) {
//        val adapter = ArrayAdapter(this, android.R.layout.simple_dropdown_item_1line, stationNames)
//        views.sourceAtv.setAdapter(adapter)
//        views.destAtv.setAdapter(adapter)
//    }
//
...
//        views: DialogViews,
//        prefs: android.content.SharedPreferences,
//        stations: List<com.metro.delhimetrotracker.data.local.database.entities.MetroStation>
//    ) {
//        views.btnStart.setOnClickListener {
//            val sourceName = views.sourceAtv.text.toString()
//            val destName = views.destAtv.text.toString()
//
//            if (!validateStations(sourceName, destName)) return@setOnClickListener
//
//            if (views.switchSchedule.isChecked) {
//                handleScheduleMode(dialog, views, stations, sourceName, destName)
//            } else {
//                handleInstantMode(dialog, views, prefs, sourceName, destName)
//            }
//        }
//    }
//
//    private fun validateStations(sourceName: String, destName: String): Boolean {
//        if (sourceName.isEmpty() || destName.isEmpty()) {
//            Toast.makeText(this, "Select Both Stations!", Toast.LENGTH_SHORT).show()
//            return false
//        }
//        if (sourceName == destName) {
...
//    }
//
//    private fun handleScheduleMode(
//        dialog: Dialog,
//        views: DialogViews,
//        stations: List<com.metro.delhimetrotracker.data.local.database.entities.MetroStation>,
//        sourceName: String,
//        destName: String
//    ) {
//        val timeText = views.tvSelectTime.text.toString()
//        if (timeText.contains("Select Time")) {
...
//
//            if (activeTrip != null) {
//                showActiveTripDialog(dialog, activeTrip)
//                return@launch
//            }
//
//            withContext(Dispatchers.Main) {
//                val phone = validateAndGetPhone(views, prefs) ?: return@withContext
//                val selectedPreference = getRoutePreference(views)
//                dialog.dismiss()
//                createNewTripAndStartService(sourceName, destName, phone, selectedPreference)
//            }
//        }
//    }
//
//    private suspend fun showActiveTripDialog(dialog: Dialog, activeTrip: Trip) {
//        withContext(Dispatchers.Main) {
//            MaterialAlertDialogBuilder(this@MainActivity)
//                .setTitle("⚠️ Active Trip in Progress")
//                .setMessage("You have an active trip from ${activeTrip.sourceStationName} to ${activeTrip.destinationStationName}.\n\nPlease complete or cancel your current trip before starting a new one.")
...
//    }
//
//    private fun validateAndGetPhone(views: DialogViews, prefs: android.content.SharedPreferences): String? {
//        if (!views.cbSms.isChecked) return ""
//
//        val rawPhone = views.phoneEt.text.toString().replace("\\s".toRegex(), "")
//        if (rawPhone.length != 10 || !rawPhone.all { it.isDigit() }) {
//            Toast.makeText(this, "Enter valid 10-digit number!", Toast.LENGTH_SHORT).show()
//            return null
//        }
//        prefs.edit().putString("last_phone", rawPhone).apply()
//        return rawPhone
//    }
//
//    private fun getRoutePreference(views: DialogViews): RoutePlanner.RoutePreference {
//        return when (views.routePreferenceGroup.checkedRadioButtonId) {
//            R.id.rbLeastInterchanges -> RoutePlanner.RoutePreference.LEAST_INTERCHANGES
//            else -> RoutePlanner.RoutePreference.SHORTEST_PATH
//        }
//    }
//
//    private fun setupSwapButton(views: DialogViews) {
//        views.btnSwap.setOnClickListener {
//            val currentSource = views.sourceAtv.text.toString()
//            val currentDest = views.destAtv.text.toString()
//            views.sourceAtv.setText(currentDest, false)
//            views.destAtv.setText(currentSource, false)
//            views.btnSwap.animate().rotationBy(180f).setDuration(300).start()
//        }
//    }
//
//    private fun setupScheduleToggle(views: DialogViews) {
//        views.switchSchedule.setOnCheckedChangeListener { _, isChecked ->
//            views.layoutScheduleOptions.visibility = if (isChecked) View.VISIBLE else View.GONE
//            views.btnStart.text = if (isChecked) "SCHEDULE" else "START"
//        }
//    }
//
//    private fun setupTimeSelection(views: DialogViews) {
//        views.tvSelectTime.setOnClickListener {
//            val cal = Calendar.getInstance()
//            TimePickerDialog(this, { _, hourOfDay, minute ->
//                views.tvSelectTime.tag = "$hourOfDay:$minute"
//                val amPm = if (hourOfDay >= 12) "PM" else "AM"
//                val displayHour = if (hourOfDay % 12 == 0) 12 else hourOfDay % 12
//                views.tvSelectTime.text = String.format("%02d:%02d %s", displayHour, minute, amPm)
//            }, cal.get(Calendar.HOUR_OF_DAY), cal.get(Calendar.MINUTE), false).show()
//        }
//    }
//
//    private fun setupFrequencyToggle(views: DialogViews) {
//        views.radioGroupFreq.setOnCheckedChangeListener { _, checkedId ->
//            views.layoutDays.visibility = if (checkedId == R.id.radioRecurring) View.VISIBLE else View.GONE
//        }
//    }
//
//    private fun setupSmsToggle(views: DialogViews) {
//        views.cbSms.setOnCheckedChangeListener { _, isChecked ->
//            views.layoutPhone.visibility = if (isChecked) View.VISIBLE else View.GONE
//        }
//    }
//
//    private fun setupContactPicker(views: DialogViews) {
//        views.btnPickContact.setOnClickListener {
//            contactPickerLauncher.launch(null)
//        }
//    }
//
//    private fun setupCancelAndToolbar(dialog: Dialog, views: DialogViews) {
//        views.toolbar.setNavigationOnClickListener { dialog.dismiss() }
//        views.btnCancel.setOnClickListener { dialog.dismiss() }
//    }
//
//    private fun setupRechargeButton(views: DialogViews) {
//        val sarthiPackage = "com.sraoss.dmrc"
//        if (isAppInstalled(sarthiPackage)) {
//            views.btnRecharge.text = "Recharge via Sarthi App"
//            views.btnRecharge.setIconResource(android.R.drawable.ic_menu_send)
//        } else {
//            views.btnRecharge.text = "Install DMRC Sarthi"
//            views.btnRecharge.setIconResource(android.R.drawable.stat_sys_download)
//        }
//
//        views.btnRecharge.setOnClickListener {
//            if (isAppInstalled(sarthiPackage)) {
//                val intent = packageManager.getLaunchIntentForPackage(sarthiPackage)
//                startActivity(intent)
//            } else {
